					...
					children.each(function(key, child) {
						...
						if ((columnizerParent.length == 0 || columnizerParent.is('[data-allow-elementresizer]') !== false) && !(child.closest('[data-no-elementresizer]').length > 0 || child[0].hasAttribute('data-no-elementresizer'))) {
							...
							var childWidth = child.width(),
								...
								noResize = isVideoPlayer ?
									child.closest('.video_component').parent('[data-elementresizer-no-resize]').length > 0 || child.closest('.video_component')[0].hasAttribute('data-elementresizer-no-resize') :
									child.parent('[data-elementresizer-no-resize]').length > 0 || child[0].hasAttribute('data-elementresizer-no-resize'),

								noVerticalResize = isVideoPlayer ?
									child.closest('.video_component').parent('[data-elementresizer-no-vertical-resize]').length > 0 || child.closest('.video_component')[0].hasAttribute('data-elementresizer-no-vertical-resize') :
									child.parent('[data-elementresizer-no-vertical-resize]').length > 0 || child[0].hasAttribute('data-elementresizer-no-vertical-resize'),									

								noCentering = isVideoPlayer ?
									child.closest('.video_component').parent('[data-elementresizer-no-centering]').length > 0 || child.closest('.video_component')[0].hasAttribute('data-elementresizer-no-centering') :
									child.parent('[data-elementresizer-no-centering]').length > 0 || child[0].hasAttribute('data-elementresizer-no-centering'),
								...
								childObj = {
									...
									noVerticalResize : noVerticalResize,
									prevLeftMargin   : 0,
